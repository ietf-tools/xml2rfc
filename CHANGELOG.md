...
- Updated the sorting to not sort the ref keys surrounded by squere brackets, instead sorting only the key strings.  Fixes issue [#250](https://github.com/ietf-tools/xml2rfc/issues/250).  
