...
xml2rfc (3.12.0) ietf; urgency=high
  * Security release - disallow includes from local filesystem by default.
    Adds a --allow-local-file-access flag (and associated library
    configuration option) to allow it.

 -- Robert Sparks <rjsparks@nostrum.com>  08 Dec 2021 19:04:11 +0000

xml2rfc (3.11.1) ietf; urgency=high
  * Cosmetic release to address changelog formatting

 -- Robert Sparks <rjsparks@nostrum.com>  29 Oct 2021 18:05:03 +0000
...
xml2rfc (3.9.1) ietf; urgency=low
 ...
 -- Robert Sparks <rjsparks@nostrum.com>  25 Jun 2021 19:02:15 +0000
...
xml2rfc (3.6.0) ietf; urgency=medium
 ...
 -- Robert Sparks <rjsparks@nostrum.com>  17 Mar 2021 18:53:29 +0100


xml2rfc (3.5.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  18 Nov 2020 11:15:50 +0100


xml2rfc (3.4.0) ietf; urgency=medium

  * Added handling for 'indent' attributes that have been set to the empty
    string.  Fixes issue #564.

  * Added some new unlisted switches to make some test cases easier to 
    maintain.

  * Changed the default handling for draft reference XIncludes to use 
    revision-agnostic bibxml URLs in v2-to-v3 conversions, and added a switch 
    to use explicit revisions instead if desired.

  * Tweaked doc.py and doc.xml to suppress mention of switches with 
    argparse.SUPPRESS help settings, for consistency between --help and --doc 
    output.

  * Changed the text output for <xref format='title'/> on request from the 
    RPC.  Fixes issue #563.

 -- Henrik Levkowetz <henrik@levkowetz.com>  06 Nov 2020 04:54:48 -0800


xml2rfc (3.3.0) ietf; urgency=medium

  * Removed validation before unprepping in order to be able to process source
    files that use XInclude without failing validation because of missing IDREF
    targets.

  * Fixed a problem where some name entries permitted Latin script names, 
    but not all.  Fixed a misleading error message for <iref> elements that
    lack a useful anchor to refer back to.

  * Fixed some diff exclusion patterns in the Makefile.

  * Added a couple of test cases.

 -- Henrik Levkowetz <henrik@levkowetz.com>  19 Oct 2020 09:10:14 -0700
...
xml2rfc (3.2.1) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  29 Sep 2020 05:22:05 -0700
...
xml2rfc (3.2.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  24 Sep 2020 02:59:52 -0700

xml2rfc (3.1.1) ietf; urgency=medium

  * Fixed an issue with empty table cells that could cause an exception.

 -- Henrik Levkowetz <henrik@levkowetz.com>  13 Sep 2020 15:45:05 -0700
...
xml2rfc (3.1.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  13 Sep 2020 08:51:53 -0700
...
xml2rfc (3.0.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  02 Sep 2020 04:35:24 -0700
...
xml2rfc (2.47.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  17 Jul 2020 14:08:26 -0700
...
xml2rfc (2.46.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  23 Jun 2020 10:28:56 -0700


xml2rfc (2.45.3) ietf; urgency=medium

  * Fixed an issue with rendering empty <dd/> elements.

 -- Henrik Levkowetz <henrik@levkowetz.com>  08 Jun 2020 07:52:50 -0700


xml2rfc (2.45.2) ietf; urgency=medium

  * Fixed the HTML styling of <ul spacing="compact"/> lists, which wasn't 
    really compact.

 -- Henrik Levkowetz <henrik@levkowetz.com>  02 Jun 2020 08:07:51 -0700
...
xml2rfc (2.45.1) ietf; urgency=medium
  ...
  * Changed the handling of hyphens in table cells, so as to introduce line 
    ...
    not otherwise).  The --table-hyphen-breaks switch can be used to permit 
    line breaks on hyphens in table cells also for tables that would not 
    otherwise become too wide.

  * Added a switch --table-hyphen-breaks that will make the text renderer 
    more eager to break on hyphens in table cells.

  * Using a pilcrow on an otherwise empty element added unwanted vertical
    space in the HTML output; avoid this.  Related to issue #508.

  * Added a parameter to TextSplitter to control whether text is split on 
    hyphens or not.

 -- Henrik Levkowetz <henrik@levkowetz.com>  30 May 2020 04:55:22 -0700
...
xml2rfc (2.45.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  27 May 2020 04:08:18 -0700
...
xml2rfc (2.44.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  22 Apr 2020 14:49:39 -0700
...
xml2rfc (2.43.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  14 Apr 2020 07:00:32 -0700
...
xml2rfc (2.42.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  02 Apr 2020 11:25:57 -0700
...
xml2rfc (2.41.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  20 Mar 2020 11:58:50 -0700
...
xml2rfc (2.40.1) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  27 Feb 2020 15:05:04 -0800
...
xml2rfc (2.40.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  18 Feb 2020 13:37:07 -0800
...
xml2rfc (2.39.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  31 Jan 2020 03:37:59 -0800


xml2rfc (2.38.2) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  27 Jan 2020 16:29:18 +0000
...
xml2rfc (2.38.1) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  20 Jan 2020 07:30:55 -0800
...
xml2rfc (2.38.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  14 Jan 2020 10:34:43 -0800
...
xml2rfc (2.37.3) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  22 Dec 2019 10:02:59 -0800
...
xml2rfc (2.37.2) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  17 Dec 2019 11:00:48 -0800
...
xml2rfc (2.37.1) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  12 Dec 2019 05:16:50 -0800
...
xml2rfc (2.37.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  10 Dec 2019 08:56:57 -0800
...
xml2rfc (2.36.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  02 Dec 2019 08:20:00 -0800


xml2rfc (2.35.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  12 Nov 2019 05:41:35 -0800
...
xml2rfc (2.34.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  23 Oct 2019 08:52:03 -0700
...
xml2rfc (2.33.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  16 Oct 2019 09:39:03 -0700
...
xml2rfc (2.32.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  04 Oct 2019 05:37:39 -0700
...
xml2rfc (2.31.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  25 Sep 2019 13:40:47 -0700
...
xml2rfc (2.30.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  19 Sep 2019 04:49:45 -0700
...
xml2rfc (2.29.1) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  18 Sep 2019 08:23:10 -0700
...
xml2rfc (2.29.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  17 Sep 2019 14:14:10 -0700
...
xml2rfc (2.28.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  15 Sep 2019 13:22:04 -0700
...
xml2rfc (2.27.1) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  10 Sep 2019 08:46:33 -0700
...
xml2rfc (2.27.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  09 Sep 2019 10:03:13 -0700
...
xml2rfc (2.26.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  03 Sep 2019 12:57:11 -0700
...
xml2rfc (2.25.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  26 Aug 2019 05:43:29 -0700
...
xml2rfc (2.24.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  10 Aug 2019 08:22:50 -0700
...
xml2rfc (2.23.1) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  07 Jul 2019 15:40:53 -0700
...
xml2rfc (2.23.0) ietf; urgency=medium
 ...
 -- Henrik Levkowetz <henrik@levkowetz.com>  27 Jun 2019 04:32:23 -0700
