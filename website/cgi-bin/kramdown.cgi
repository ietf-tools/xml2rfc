...
<<COMMENT;
########################### #######
 Process an kramdown conversion request

 invoking form has these fields:
	file "input" or "url"
	    contains the kramdown file
	radio button "type"
...
####### #	kramdown-rfc2629 $inputfn
####### #		check for errors
####### ########################### #######
####### #
####### # Run kramdown-rfc2629 to: expand internal references and includes.
####### #
####### ########################### #######

my $curfile = $newinputfn;

my $tmpout = callKramDown("xml");
$curfile = $tmpout;
...
if ($type eq 'towindow') {
    ...
    print "<html><head><title>KramDown-RFC2629 Processor with Warnings &amp; Errors</title></head>\n";
