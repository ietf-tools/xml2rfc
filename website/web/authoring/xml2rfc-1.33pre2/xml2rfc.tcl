...
proc pass {tag} {
    ...
    switch -- $tag {
        start {
            ...
            array set options [list authorship  yes \
                                    autobreaks  yes \
                                    background  ""  \
                                    colonspace  no  \
                                    comments    no  \
...
# draft-ietf-ipr-ietf-trust-update modification to copylong2
set copylong4 {
...
# draft-ietf-ipr-ietf-trust-update modification to copylong3
set copylong5 {
"Copyright &copy; The IETF Trust (%YEAR%)."
...
# draft-ietf-ipr-ietf-trust-update modification to copyshort2
set copyshort3 \
"Copyright &copy; The IETF Trust (%YEAR%)."
...
proc xdv::report {result stack} {
	...
	# only report stack if fatal.  is that logic right?
	if {$options(.STRICT)} {
	    set text "Syntax:"
	    while {$i > 0} {
		set frame [lindex $stack [incr i -1]]
