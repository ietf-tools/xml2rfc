                ...
                if {$passno == 1} {
                    ...
                    if {[info exists attrs(.TEXTWIDTH)]} {
                        ...
                        switch -- $align {
                            ...
                            default {
                                unexpected error \
                                    "<artwork align=\"$align\"> is invalid"
                            }
                        }
                        if {$pre < 0} {
                            set pre 0
...
proc pass2begin_artwork {elemX} {
    ...
    artwork_$mode begin [array get attrs]
}
...
proc pass2end_artwork {elemX} {
    ...
    artwork_$mode end [array get attrs]
