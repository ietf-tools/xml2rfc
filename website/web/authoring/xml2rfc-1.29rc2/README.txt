...
Table of Contents
   ...
   5.    Additions to RFC 2629  . . . . . . . . . . . . . . . . . . . 10
   6.    Limitations of xml2rfc . . . . . . . . . . . . . . . . . . . 12
   7.    References . . . . . . . . . . . . . . . . . . . . . . . . . 12
         Author's Address . . . . . . . . . . . . . . . . . . . . . . 12
   A.    MacOS 9 Installation (courtesy of Ned Freed) . . . . . . . . 13
   B.    rfc2629.xslt (courtesy of Julian Reschke)  . . . . . . . . . 14
   C.    MS-Windows XP/Cygwin Installation (courtesy of Joe Touch)  . 15
...
Rose                                                            [Page 1]

README                      xml2rfc v1.29rc2                January 2005
...
README                      xml2rfc v1.29rc2                January 2005
   ...
   |              |              | point in processing                 |
   |              |              |                                     |
   |    useobject |      no      | when producing an html file, use    |
   |              |              | the "<object>" html element with    |
   |              |              | inner replacement content instead   |
   |              |              | of the "<img>" html element, when a |
...
README                      xml2rfc v1.29rc2                January 2005
   ...
   |              |              | source xml element includes an      |
   |              |              | "src" attribute                     |
   +--------------+--------------+-------------------------------------+
   ...
   With the exception of the "needLines" and "typeout" PIs, you normally
   put all of these processing instructions at the beginning of the
   document (right after the XML declaration).
...
Appendix B.  rfc2629.xslt (courtesy of Julian Reschke)
   ...
   (i.e., MSIE6) to produce HTML.  A word of warning though: the XSLT
...
Appendix C.  MS-Windows XP/Cygwin Installation (courtesy of Joe Touch)
   ...
   1.  install Cygwin: follow instructions at the Cygwin website [5]
       (also visit the Cygwin pages on the Tcl Wiki [6]), make sure to
       select "tcltk" in "Libs"

   2.  place a copy of xml2rfc files on a local drive,  e.g., in "C:
       \xml2rfc" NOTE: for xml2rfc-1.26 and earlier, see NOTE below.

   3.  place a copy of bibxml* files on a local drive, e.g., in "C:
       \xmlbib\"
