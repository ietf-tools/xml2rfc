 ...
 *
 * $Id: tclexpat.c,v 1.3 2000/07/23 23:52:01 svispute Exp $
 *
 */

#include <tcl.h>
#include "xmlparse.h"
#define  MTR  /* propagate return codes upwards... */
     ...
     Tcl_Obj *CONST objv[];
{
  ...
  switch ((enum options) index) {
    case EXPAT_CONFIGURE:
      ...
      result = TclExpatConfigure(interp, clientData, objc - 2, objv + 2);
      break;

    case EXPAT_CGET:

      result = TclExpatCget(interp, clientData, objc - 2, objv + 2);
      break;
