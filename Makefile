...
cachetest: install
	...
	@ PYTHONPATH=$$PWD python scripts/xml2rfc --cache .cache tests/input/rfc6787.xml --base tmp/ --raw
	@ PYTHONPATH=$$PWD python scripts/xml2rfc --cache .cache tests/input/rfc6787.xml --no-network --base tmp/ --raw
