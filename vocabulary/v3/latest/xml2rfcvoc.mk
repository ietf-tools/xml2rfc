xml2rfc.all: \
	draft-iab-xml2rfc-latest.xml xml2rfcv3-annotated.rng
...
xml2rfcv3-annotated.rng: xml2rfcv3.rng annotate-rng.xslt draft-iab-xml2rfc-latest.xml
	saxon $< annotate-rng.xslt doc=draft-iab-xml2rfc-latest.xml > $@

xml2rfcv3-spec.xml: xml2rfcv3.rng rng2xml2rfc.xslt
	saxon $< rng2xml2rfc.xslt voc=v3 specsrc=draft-iab-xml2rfc-latest.xml > $@

xml2rfcv3-spec-deprecated.xml: xml2rfcv3.rng rng2xml2rfc.xslt
	saxon $< rng2xml2rfc.xslt specsrc=draft-iab-xml2rfc-latest.xml deprecated=yes > $@

xml2rfcv3.rnc.folded: xml2rfcv3.rnc
	./fold-rnc.sh $< > $@

draft-iab-xml2rfc-latest.xml: xml2rfcv3-spec.xml xml2rfcv3-spec-deprecated.xml xml2rfcv3.rnc.folded differences-from-v2.txt
	cp -v $@ $@.bak
